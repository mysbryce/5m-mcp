...
**5m-mcp** ships a single FiveM resource — named `agent_api` once installed — that exposes a [Model Context Protocol (MCP)](https://modelcontextprotocol.io/) server. Once installed and started, any MCP-aware coding agent — Claude Code, Codex CLI, Cursor, Cline, your own — can:
